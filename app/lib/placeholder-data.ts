...
const snippetTags = [
  { snippetId: 'q-rsqrt', tagId: '位运算技巧' },
  { snippetId: 'q-rsqrt', tagId: '浮点黑魔法' },
  { snippetId: 'q-rsqrt', tagId: '性能优化' },
  { snippetId: 'container-of', tagId: '宏技巧' },
  { snippetId: 'container-of', tagId: '数据结构' },
  { snippetId: 'container-of', tagId: '侵入式设计' },
  { snippetId: 'redis-skiplist', tagId: '概率数据结构' },
  { snippetId: 'redis-skiplist', tagId: '对数复杂度' },
  { snippetId: 'redis-skiplist', tagId: '高效搜索' },
  { snippetId: 'spsc-queue', tagId: '无锁编程' },
  { snippetId: 'spsc-queue', tagId: '内存模型' },
  { snippetId: 'spsc-queue', tagId: '高性能' },
  { snippetId: 'cached-property', tagId: '设计模式' },
  { snippetId: 'cached-property', tagId: '惰性求值' },
  { snippetId: 'cached-property', tagId: '语言特性妙用' },
  { snippetId: 'goroutine-leak', tagId: '测试技巧' },
  { snippetId: 'goroutine-leak', tagId: '资源管理' },
  { snippetId: 'goroutine-leak', tagId: '调试' },
  { snippetId: 'next-pow2', tagId: '位运算技巧' },
  { snippetId: 'next-pow2', tagId: '高性能' },
  { snippetId: 'next-pow2', tagId: '哈希算法' },
  { snippetId: 'bloom-filter', tagId: '概率数据结构' },
  { snippetId: 'bloom-filter', tagId: '空间优化' },
  { snippetId: 'bloom-filter', tagId: '哈希设计' },
  { snippetId: 'duffs-device', tagId: '循环展开' },
  { snippetId: 'duffs-device', tagId: '编译器合作' },
  { snippetId: 'duffs-device', tagId: '奇技淫巧' },
  { snippetId: 'elixir-parser', tagId: '函数式编程' },
  { snippetId: 'elixir-parser', tagId: '解析器设计' },
  { snippetId: 'elixir-parser', tagId: '尾递归优化' },
  { snippetId: 'kfifo', tagId: '无锁编程' },
  { snippetId: 'kfifo', tagId: '内存屏障' },
  { snippetId: 'kfifo', tagId: '内核技巧' },
  { snippetId: 'python-with', tagId: '语言特性' },
  { snippetId: 'python-with', tagId: '资源管理' },
  { snippetId: 'python-with', tagId: '代码模式' },
  { snippetId: 'redis-sds', tagId: '内存管理' },
  { snippetId: 'redis-sds', tagId: '数据结构' },
  { snippetId: 'redis-sds', tagId: '嵌入式元信息' },
  { snippetId: 'quicksort-3way', tagId: '排序算法' },
  { snippetId: 'quicksort-3way', tagId: '重复数据优化' },
  { snippetId: 'quicksort-3way', tagId: '经典实现' },
  { snippetId: 'zero-length-array', tagId: '内存打包' },
  { snippetId: 'zero-length-array', tagId: '数据结构' },
  { snippetId: 'zero-length-array', tagId: '性能' },
  { snippetId: 'sync-once', tagId: '并发控制' },
  { snippetId: 'sync-once', tagId: '原子操作' },
  { snippetId: 'sync-once', tagId: '设计模式' },
  { snippetId: 'bit-reverse', tagId: '位运算技巧' },
  { snippetId: 'bit-reverse', tagId: '分治' },
  { snippetId: 'bit-reverse', tagId: '无分支编程' },
  { snippetId: 'do-while-0', tagId: '预处理器技巧' },
  { snippetId: 'do-while-0', tagId: '防御性编程' },
  { snippetId: 'do-while-0', tagId: '宏安全' },
  { snippetId: 'unsigned-sub', tagId: '溢出利用' },
  { snippetId: 'unsigned-sub', tagId: '协议设计' },
  { snippetId: 'unsigned-sub', tagId: '位运算' },
  { snippetId: 'select-timeout', tagId: '网络编程' },
  { snippetId: 'select-timeout', tagId: '超时模式' },
  { snippetId: 'select-timeout', tagId: '系统调用复用' },
];

export { snippets, tags, snippetTags };