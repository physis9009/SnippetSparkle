    ...
    return (
        ...
        ">
            ...
            <div>
                ...
                <input id="email" type="email" name="email" className="border border-blk-gr rounded-sm my-2 bg-wht-md"></input>
            </div>

            <div>
                <label htmlFor="password">Password: </label>
                <input id="password" type="password" name="password" className="border border-blk-gr rounded-sm my-2 bg-wht-md"/>
            </div>
            
            
            <button type="submit" className="
                hover:cursor-pointer border border-wht rounded-sm text-wht-md hover:text-wht
                bg-grn-gr hover:bg-grn px-2 italic my-2 font-semibold text-lg
            ">Sign in</button>
